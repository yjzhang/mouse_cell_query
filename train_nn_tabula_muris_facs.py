...
all_matrices = sparse.csr_matrix(scipy.io.mmread('tm_facs_all_matrices.mtx').T)
...
# train model on FACS data, test on 
...
print('test accuracy of facs model on facs data:', accuracy)
model.save('tm_facs_model.h5')
print('saved facs-seq model')

# test on droplet-seq?
# afsndlsdkl labels are different
