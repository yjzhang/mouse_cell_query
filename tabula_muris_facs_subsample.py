...
data.to_csv('tm_facs_data_subset.csv')
data.to_csv('tm_facs_data_subset.tsv', sep='\t')
...
data_means = dense_matrix_h5.H5Dict('mouse_cell_query/data/cell_type_means_tm_facs.h5')
all_means = []
...
data.index = [x.upper() for x in genes]
data.to_csv('tm_facs_data_means.csv')
