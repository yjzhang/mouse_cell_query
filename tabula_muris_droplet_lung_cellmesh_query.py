...
scipy.io.mmwrite('tm_droplet_lung_all_matrices.mtx', all_matrices)
np.savetxt('tm_droplet_lung_all_labels.txt', all_labels, fmt='%s')

"""

##########################################################################
genes = np.loadtxt('mouse_cell_query/data/gene_names.txt', dtype=str)
# this is in the file as a cell x gene matrix. should be a gene x cell matrix.
all_matrices = scipy.io.mmread('Lung.mtx.gz').T
all_labels = np.loadtxt('Lung_cell_types.txt', dtype=str, delimiter='##')
...
with open('tm_droplet_lung_t_scores.pkl', 'wb') as f:
    pickle.dump(scores_t, f)
with open('tm_droplet_lung_t_pvals.pkl', 'wb') as f:
    pickle.dump(pvals_t, f)
with open('tm_droplet_lung_u_pvals.pkl', 'wb') as f:
    pickle.dump(pvals_u, f)
############################################################################

# 3. for each cluster, run cellmesh and cellmarker

with open('tm_droplet_lung_t_scores.pkl', 'rb') as f:
    scores_t = pickle.load(f)
with open('tm_droplet_lung_t_pvals.pkl', 'rb') as f:
    pvals_t = pickle.load(f)
with open('tm_droplet_lung_u_pvals.pkl', 'rb') as f:
...
top_genes_ratio.to_csv('tabula_muris_dropseq_lung_top_genes_ratio.csv')
...
with open('tm_droplet_lung_cellmesh_query_results.pkl', 'wb') as f:
    pickle.dump(label_results, f)
with open('tm_droplet_lung_cellmesh_query_top_cells.pkl', 'wb') as f:
...
plt.savefig('map_ratios_tm_droplet_lung_all_cell_types.png', dpi=100)
...
plt.savefig('map_ratios_tm_droplet_lung.png', dpi=100)
...
plt.ylim(0, 0.8)
plt.title('Cell Type Annotation Accuracy')
plt.savefig('map_ratios_tm_droplet_lung_with_scquery.png', dpi=100)
...
plt.savefig('top_1_accuracy_tm_droplet_lung.png', dpi=100)
...
plt.savefig('top_3_accuracy_tm_droplet_lung.png', dpi=100)
...
plt.savefig('top_5_accuracy_tm_droplet_lung.png', dpi=100)
...
plt.savefig('top_5_accuracy_tm_droplet_lung_50_genes.png', dpi=100)
fig, ax = plt.subplots(figsize=(18, 10))
...
plt.savefig('top_3_accuracy_tm_droplet_lung_50_genes.png', dpi=100)
