...
mouse_cell_query.search_db(np.array(data[:, labels==0].mean(1)).flatten(), genes, method='spearman')
mouse_cell_query.search_db(np.array(data[:, labels==0].mean(1)).flatten(), genes, method='poisson')
mouse_cell_query.search_db(np.array(data[:, labels==1].mean(1)).flatten(), genes, method='poisson')
